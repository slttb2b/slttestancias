...
export const INITIAL_ROOMS: Room[] = [
  ...
  {
    id: 'mesa-horizon-villa',
    name: 'Mesa Horizon Villa',
    category: 'Mesa Collection',
    tagline: 'Luxury cliffside & garden pavilion with panoramic views',
    shortDescription: 'An exclusive retreat featuring high ceilings, panoramic windows, bespoke wooden accents, and a private terrace.',
    fullDescription: 'The Mesa Horizon Villa elevates the SLTT Estancias experience with elevated hilltop serenity, modern luxury finishes, artisan craftsmanship, an expansive dining and lounge deck, and sweeping views of the mountains and sanctuary gardens.',
    maxGuests: 12,
    bedType: '2 King Beds + 2 Daybeds',
    sizeSqM: 65,
    pricePerNight: 5500,
    featuredImage: 'https://images.unsplash.com/photo-1618773928121-c32242e63f39?auto=format&fit=crop&w=1000&q=80',
    galleryImages: [
      'https://images.unsplash.com/photo-1618773928121-c32242e63f39?auto=format&fit=crop&w=1000&q=80',
      'https://images.unsplash.com/photo-1582719478250-c89cae4dc85b?auto=format&fit=crop&w=1000&q=80',
      villaPoolImg,
    ],
    amenities: ['Private Mountain Terrace', 'Air Conditioning', 'High-Speed Wi-Fi', 'Smart TV with Netflix', 'Minibar & Refrigerator', 'Rainfall Shower', 'Artisan Dining Table', 'Complimentary Breakfast for 6'],
    isAvailable: true,
    blockedDates: [],
  },
  {
    id: 'mesa-sanctuary-suite',
    name: 'Mesa Sanctuary Suite',
    category: 'Mesa Collection',
    tagline: 'Intimate elevated suite surrounded by tropical flora',
    shortDescription: 'A peaceful, designer sanctuary tailored for romantic couples or small families seeking refined comfort.',
    fullDescription: 'A blend of contemporary tropical architecture and organic textures, the Mesa Sanctuary Suite offers plush king bedding, ambient designer lighting, an en-suite spa shower, and private balcony seating overlooking the resort canopy.',
    maxGuests: 4,
    ...
    amenities: ['Private Scenic Balcony', 'Air Conditioning', 'Free Wi-Fi', 'Smart TV', 'Hot & Cold Rainfall Shower', 'Coffee & Tea Bar', 'Mini Fridge'],
    isAvailable: true,
    blockedDates: [],
  },
];
